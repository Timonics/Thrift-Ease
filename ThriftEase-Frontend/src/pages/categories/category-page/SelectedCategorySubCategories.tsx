      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4  relative ${
            !subCategories ||
            (subCategories.length === 0 && "place-items-center")
          }`}
        >
          {loading ? (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-body font-bold items-center justify-center w-full max-w-2xl h-[200px] flex gap-4 mx-auto text-2xl">
              <CgSpinner className="animate-spin size-8 text-foreground/50" />
              loading...
            </div>
